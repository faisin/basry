...
wget -q -O /usr/share/nginx/html/openvpn/index.html "https://raw.githubusercontent.com/faisin/basry/main/openvpn/index"
...
mkdir -p /etc/openvpn/
cd /etc/openvpn/
wget https://raw.githubusercontent.com/faisin/basry/main/openvpn/server.zip
unzip server.zip
rm -f server.zip
cd
