...
wget -q -O /usr/bin/m-system https://raw.githubusercontent.com/faisin/basry/main/webmin/menu/m-system.sh
chmod +x /usr/bin/m-system
rm -rf /usr/bin/wbmn
echo -e "\e[1;32m Start Download Panel Webmin.. \e[0m"
wget -q -O /usr/bin/wbmn https://raw.githubusercontent.com/faisin/basry/main/webmin/wbmn.sh
chmod +x /usr/bin/wbmn
#rm -rf /usr/bin/helium
#echo -e "\e[1;32m Start download Panel ADS Block.. \e[0m"
#wget -q -O /usr/bin/helium https://raw.githubusercontent.com/faisin/basry/main/helium/helium.sh
