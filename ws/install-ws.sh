...
for pkg in ca-certificates wget curl lsof build-essential; do
    install_package "$pkg"
done
...
if command -v node >/dev/null 2>&1; then
    ...
    if [[ $NODE_MAJOR -lt 24 ]]; then
        log "Node.js version too old ($NODE_VERSION). Installing Node.js 24 LTS..."
...
PROXY_JS_URL="https://raw.githubusercontent.com/faisin/basry/main/ws/proxy.js"
...
SERVICE_URL="https://raw.githubusercontent.com/faisin/basry/main/ws/ws-proxy.service"
